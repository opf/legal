...
5. The transfer of personal data from the Controller to the subcontractor, and their commencement of work, are only permitted if all requirements for subcontracting are met.
6. The Controller’s email address shall be used for purposes of implementing a change in subcontractors by means of sending a newsletter.
7. If the Controller objects to a change in subcontractors without indicating data protection-related grounds, the Processor is entitled to exercise an extraordinary right to terminate the contract to provide services referred to in Section 1, provided that the Processor cannot reasonably be expected to remain obliged under such contract subject to retention of the contractor concerned.
