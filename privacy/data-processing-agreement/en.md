...
2. The Controller agrees to the [sub-processors](https://www.openproject.org/legal/data-processing-agreement/sub-processors/) named at the time of the conclusion of this contract. The Processor warrants that an data processing agreement has been concluded with all named sub-processors in accordance with Article 28 (2-4) of the GDPR.
